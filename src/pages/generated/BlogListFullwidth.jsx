...
const BlogListFullwidth = () => {
  ...
  return (
    ...
    <div className="section section-padding">
        <div className="container">
            <div className="row g-0 learts-mb-n40">

                <div className="col-12 border-bottom learts-pb-40 learts-mb-40">
                    <div className="blog">
                        <div className="row learts-mb-n30">
                            <div className="col-xl-4 col-md-5 col-12 learts-mb-30">
                                <div className="image mb-0">
                                    <Link to="/blog-details-right-sidebar"><img src="/assets/images/blog/s345/blog-1.webp" alt="Blog Image" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-8 col-md-7 col-12 align-self-center learts-mb-30">
                ...
                <div className="col-12 border-bottom learts-pb-40 learts-mb-40">
                    <div className="blog">
                        <div className="row learts-mb-n30">
                            <div className="col-xl-4 col-md-5 col-12 learts-mb-30">
                                <div className="image mb-0">
                                    <Link to="/blog-details-right-sidebar"><img src="/assets/images/blog/s345/blog-2.webp" alt="Blog Image" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-8 col-md-7 col-12 align-self-center learts-mb-30">
                                <div className="content">
                ...
                <div className="col-12 border-bottom learts-pb-40 learts-mb-40">
                    <div className="blog">
                        <div className="row learts-mb-n30">
                            <div className="col-xl-4 col-md-5 col-12 learts-mb-30">
                                <div className="image mb-0">
                                    <Link to="/blog-details-right-sidebar"><img src="/assets/images/blog/s345/blog-3.webp" alt="Blog Image" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-8 col-md-7 col-12 align-self-center learts-mb-30">
                                <div className="content">
                ...
                <div className="col-12 border-bottom learts-pb-40 learts-mb-40">
                    <div className="blog">
                        <div className="row learts-mb-n30">
                            <div className="col-xl-4 col-md-5 col-12 learts-mb-30">
                                <div className="image mb-0">
                                    <Link to="/blog-details-right-sidebar"><img src="/assets/images/blog/s345/blog-4.webp" alt="Blog Image" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-8 col-md-7 col-12 align-self-center learts-mb-30">
                                <div className="content">
                ...
                <div className="col-12 border-bottom learts-pb-40 learts-mb-40">
                    <div className="blog">
                        <div className="row learts-mb-n30">
                            <div className="col-xl-4 col-md-5 col-12 learts-mb-30">
                                <div className="image mb-0">
                                    <Link to="/blog-details-right-sidebar"><img src="/assets/images/blog/s345/blog-5.webp" alt="Blog Image" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-8 col-md-7 col-12 align-self-center learts-mb-30">
                                <div className="content">
                ...
                <div className="col-12 learts-mb-40">
                    <div className="blog">
                        <div className="row learts-mb-n30">
                            <div className="col-xl-4 col-md-5 col-12 learts-mb-30">
                                <div className="image mb-0">
                                    <Link to="/blog-details-right-sidebar"><img src="/assets/images/blog/s345/blog-6.webp" alt="Blog Image" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-8 col-md-7 col-12 align-self-center learts-mb-30">
                                <div className="content">
