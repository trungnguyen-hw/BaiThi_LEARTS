                ...
                <div className="col">
                    ...
                    <div className="page-title">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Minimalist Ceramic Pot</li>
                        </ul>
                    </div>
            ...
            <div className="row learts-mb-n40">
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-images">
                        <button className="product-gallery-popup hintT-left" data-hint="Click to enlarge" data-images='[
                            {"src": "assets/images/product/single/8/product-zoom-1.webp", "w": 700, "h": 1100}
                        ]'><i className="fas fa-expand"></i></button>
                        <div className="product-zoom" data-image="/assets/images/product/single/8/product-zoom-1.webp">
                            <img src="/assets/images/product/single/8/product-1.webp" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-summery">
                        ...
                        <h3 className="product-title">Minimalist Ceramic Pot</h3>
                        <div className="product-price">£120.00</div>
                        <div className="product-description">
                            <p>What’s in the box – 1 Ceramic Vase without flowers: Always use the Material of the best quality. Provides a modern & stylish sense to accentuate the personality of your home decor. Perfect for homeroom and office, great for adding a decorative touch to any room’s decor. After-sales Service Quality problems occur within one-year replacement, lifetime warranty.</p>
                        </div>
            ...
            <div className="tab-content product-infor-tab-content">
                            ...
                            <div className="table-responsive">
                                <table className="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <td>Material</td>
                                            <td>Pearl river, Sacramento, Steel</td>
                                        </tr>
                                        <tr>
                                            <td>Size</td>
                ...
                <div className="tab-pane fade" id="tab-reviews">
                    <div className="product-review-wrapper">
                        <span className="title">3 reviews for Minimalist Ceramic Pot</span>
...
export default ProductDetailsBackground;
