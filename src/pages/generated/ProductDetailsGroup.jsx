                ...
                <div className="col">
                    ...
                    <div className="page-title">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Aluminum Equestrian</li>
                        </ul>
                    </div>
            ...
            <div className="row learts-mb-n40">
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-images">
                        <button className="product-gallery-popup hintT-left" data-hint="Click to enlarge" data-images='[
                            {"src": "assets/images/product/single/6/product-zoom-1.webp", "w": 700, "h": 1100},
                            {"src": "assets/images/product/single/6/product-zoom-2.webp", "w": 700, "h": 1100},
                            {"src": "assets/images/product/single/6/product-zoom-3.webp", "w": 700, "h": 1100}
                        ...
                        <div className="product-gallery-slider">
                            <div className="product-zoom" data-image="/assets/images/product/single/6/product-zoom-1.webp">
                                <img src="/assets/images/product/single/6/product-1.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/6/product-zoom-2.webp">
                                <img src="/assets/images/product/single/6/product-2.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/6/product-zoom-3.webp">
                                <img src="/assets/images/product/single/6/product-3.webp" alt="" />
                            </div>
                        </div>
                        <div className="product-thumb-slider">
                            <div className="item">
                                <img src="/assets/images/product/single/6/product-thumb-1.webp" alt="" />
                            </div>
                            <div className="item">
                                <img src="/assets/images/product/single/6/product-thumb-2.webp" alt="" />
                            </div>
                            <div className="item">
                                <img src="/assets/images/product/single/6/product-thumb-3.webp" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-summery">
                        ...
                        <h3 className="product-title">Aluminum Equestrian</h3>
                        <div className="product-price">£100.00</div>
                        <div className="product-description">
                            <p>Perfect for Equestrian homes or every horse lover. Designer premium signature aluminum is compliant with FDA regulations. Aluminum Serveware can be chilled in the freezer or refrigerator and warmed in the oven to 350.</p>
                        </div>
                        <div className="group-product-list">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td className="choose"><input type="checkbox" defaultChecked="" disabled="" /></td>
                                        <td className="quantity"></td>
                                        <td className="thumb"><img src="/assets/images/product/single/6/group-product-1.webp" alt="" /></td>
                                        <td className="title">This item: <span>Aluminum Equestrian</span></td>
                                        <td className="price"><span className="pro-price"><span>£100.00</span></span></td>
                                    </tr>
                                    <tr>
                                        <td className="choose"><input type="checkbox" /></td>
                                        <td className="quantity">1</td>
                                        <td className="thumb"><img src="/assets/images/product/single/6/group-product-2.webp" alt="" /></td>
                                        <td className="title"><a href="#">Porcelain Small Bowls</a></td>
                                        <td className="price"><span className="pro-price"><span className="old">£120.00</span><span className="new">£96.00</span></span></td>
                                    </tr>
                                    <tr>
                                        <td className="choose"><input type="checkbox" /></td>
                                        <td className="quantity">1</td>
                                        <td className="thumb"><img src="/assets/images/product/single/6/group-product-3.webp" alt="" /></td>
                                        <td className="title"><a href="#">Walnut Cutting Board</a></td>
                                        <td className="price"><span className="pro-price"><span className="old">£100.00</span><span className="new">£95.00</span></span></td>
                                    </tr>
                                </tbody>
                            </table>
                            <span className="info-text">Products are available in limited quantities.</span>
                        </div>
            ...
            <div className="tab-content product-infor-tab-content">
                ...
                <div className="tab-pane fade" id="tab-reviews">
                    <div className="product-review-wrapper">
                        <span className="title">3 reviews for Aluminum Equestrian</span>
