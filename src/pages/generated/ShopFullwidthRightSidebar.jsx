...
const ShopFullwidthRightSidebar = () => {
  useEffect(() => {
        ...
        <div className="section section-fluid learts-mt-70">
            <div className="container">
                <div className="row learts-mb-n50">
                    ...
                    <div className="col-lg-9 col-12 learts-mb-50">
                    ...
                    <div className="col-lg-3 col-12 learts-mb-10">
...
export default ShopFullwidthRightSidebar;
