...
const ProductDetailsImageVariation = () => {
  useEffect(() => {
                ...
                <div className="col">
                    ...
                    <div className="page-title">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Geometric Modern Clock</li>
                        </ul>
                    </div>
            ...
            <div className="row learts-mb-n40">
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-images">
                        <button className="product-gallery-popup hintT-left" data-hint="Click to enlarge" data-images='[
                            {"src": "assets/images/product/single/5/product-zoom-1.webp", "w": 700, "h": 1100},
                            {"src": "assets/images/product/single/5/product-zoom-2.webp", "w": 700, "h": 1100},
                            {"src": "assets/images/product/single/5/product-zoom-3.webp", "w": 700, "h": 1100},
                            {"src": "assets/images/product/single/5/product-zoom-4.webp", "w": 700, "h": 1100}
                        ...
                        <div className="product-gallery-slider">
                            <div className="product-zoom" data-image="/assets/images/product/single/5/product-zoom-1.webp">
                                <img src="/assets/images/product/single/5/product-1.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/5/product-zoom-2.webp">
                                <img src="/assets/images/product/single/5/product-2.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/5/product-zoom-3.webp">
                                <img src="/assets/images/product/single/5/product-3.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/5/product-zoom-4.webp">
                                <img src="/assets/images/product/single/5/product-4.webp" alt="" />
                            </div>
                        </div>
                        <div className="product-thumb-slider">
                            <div className="item">
                                <img src="/assets/images/product/single/5/product-thumb-1.webp" alt="" />
                            </div>
                            <div className="item">
                                <img src="/assets/images/product/single/5/product-thumb-2.webp" alt="" />
                            </div>
                            <div className="item">
                                <img src="/assets/images/product/single/5/product-thumb-3.webp" alt="" />
                            </div>
                            <div className="item">
                                <img src="/assets/images/product/single/5/product-thumb-4.webp" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-summery">
                        ...
                        <h3 className="product-title">Geometric Modern Clock</h3>
                        <div className="product-price">£100.00 – £120.00</div>
                        <div className="product-description">
                            <p>This clock measures 30 x 30 cm( we can custom the size if you leave a message to us after placing the order). This wooden clock is a gift that will truly be cherished forever. Both come with hour- and minute hands in lacquered brass. The use of high-quality marble allows for a maximum appreciation of its mosaic and complex structure.</p>
                        </div>
            ...
            <div className="tab-content product-infor-tab-content">
                <div className="tab-pane fade show active" id="tab-description">
                    <div className="row">
                        <div className="col-lg-10 col-12 mx-auto">
                            <p>This clock measures 30 x 30 cm( we can custom the size if you leave a message to us after placing the order). This lock professionally engraved on to beautiful real wood. This wooden clock is a gift that will truly be cherished forever, it will be a great wedding or anniversary gift. Add all information about customization message to us if you want to custom it.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="tab-pane fade" id="tab-reviews">
                    <div className="product-review-wrapper">
                        <span className="title">3 reviews for Geometric Modern Clock</span>
...
export default ProductDetailsImageVariation;
