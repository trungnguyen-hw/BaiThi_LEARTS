...
const ProductDetails = () => {
  ...
  const handleAddToCart = (e) => {
    e.preventDefault();
    const qtyInput = document.querySelector('.product-summery .input-qty');
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-summery">
                        ...
                        <div className="product-buttons">
                            ...
                            <a href="#" className="btn btn-dark btn-outline-hover-dark" onClick={handleAddToCart}><i className="fas fa-shopping-cart"></i> Add to Cart</a>
