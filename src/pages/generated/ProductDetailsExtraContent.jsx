...
const ProductDetailsExtraContent = () => {
  useEffect(() => {
                ...
                <div className="col">
                    ...
                    <div className="page-title">
                        ...
                        <ul className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Square Serving Platter</li>
                        </ul>
                    </div>
            ...
            <div className="row learts-mb-n40">
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-images">
                        ...
                        <div className="product-gallery-slider">
                            <div className="product-zoom" data-image="/assets/images/product/single/3/product-zoom-1.webp">
                                <img src="/assets/images/product/single/3/product-1.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/3/product-zoom-2.webp">
                                <img src="/assets/images/product/single/3/product-2.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/3/product-zoom-3.webp">
                                <img src="/assets/images/product/single/3/product-3.webp" alt="" />
                            </div>
                            <div className="product-zoom" data-image="/assets/images/product/single/3/product-zoom-4.webp">
                ...
                <div className="col-lg-6 col-12 learts-mb-40">
                    <div className="product-summery">
                        ...
                        <h3 className="product-title">Square Serving Platter</h3>
                        ...
                        <div className="product-brands">
                            ...
                            <div className="brands">
                                <a href="#"><img src="/assets/images/brands/brand-2.webp" alt="" /></a>
            ...
            <div className="tab-content product-infor-tab-content">
                <div className="tab-pane fade show active" id="tab-description">
                    <div className="row">
                        <div className="col-12 mx-auto">
                            ...
                            <p>Lay this board along the centre of your table – whether for a mid-week supper or a dinner party, this beautiful piece will hold its own.</p>
                            <p>Size: Length 31 cm (41 cm inc. handle). Note: Wash and dry the boards after use. Do not leave to soak. Each Rosie Brewer board carries the maker’s mark.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row learts-mb-n30">
                        <div className="col-12 learts-mb-30">
                            <div className="row learts-mb-n10">
                                <div className="col-lg-2 col-md-3 col-12 learts-mb-10"><img src="/assets/images/brands/brand-2.webp" alt="" /></div>
                                <div className="col learts-mb-10">
                                    <p>Don’t limit yourself to just what you can do well. Try doing something new, something you might not be very good at but it is something that can teach you a lot about your work. Don’t feel compelled to work hard. Be happy that you can work hard on something. We always feel proud to spend time and effort to bring out the best clothing items to our customers.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 learts-mb-30">
                ...
                <div className="tab-pane fade" id="tab-reviews">
                    <div className="product-review-wrapper">
                        <span className="title">3 reviews for Square Serving Platter</span>
...
export default ProductDetailsExtraContent;
